...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-auto flex items-center justify-center relative p-20"
      ref={containerRef}
  ...
  return (
    <motion.div 
      style={{
        ...
        boxShadow:
          "0 10 #000004d, 0 900px 20px #0000004a, 0 37px 37px #00000042, 0 84px 50px #00000026, 0 149px 60px #0000000a, 0 233px 65px #00000003",
      }}
